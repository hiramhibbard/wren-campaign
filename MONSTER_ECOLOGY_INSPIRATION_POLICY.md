...
The campaign must continue to feel like AD&D 2e rather than modern 5e-style play.

Reject, rewrite, or ignore ecology-inspiration material when it depends on or strongly imports:
- 5e mechanics, action economy, bounded accuracy, advantage/disadvantage, proficiency-bonus logic, lair-action/legendary-action assumptions, modern condition terminology, challenge-rating encounter construction, or encounter balancing by party level;
- level-scaled monster variants created mainly to make a creature an appropriate fight for a party tier;
- modern encounter-design assumptions that every monster appearance should be a balanced combat set piece;
- 5e-specific cosmology, faction lore, monster origin, biology, spell effects, class assumptions, alignment treatment, or setting facts that conflict with or are unsupported by the active AD&D 2e source/setting;
- modern heroic-survivability assumptions that undermine Wren's established low-level fragility, no-plot-protection rule, morale, reaction, avoidance, retreat, or genuine random danger;
- lore that turns uncertain or campaign-specific questions into universal facts without support from the governing 2e/setting source.

When an inspiration idea is edition-neutral in substance, it may be adapted into an AD&D 2e idiom. The resulting campaign fact must be justified by 2e source compatibility and current world causality, not by the inspiration source's edition.

## Appropriate uses

The inspiration layer is best used to generate candidate answers for gaps or underdeveloped areas such as:
- lifecycle, reproduction, young, aging, and population recovery;
- feeding, prey, predators, scavenging, resource pressure, and territorial needs;
- daily/activity patterns and seasonal behavior;
- lair selection, nesting, sanitation, waste, food storage, and shelter;
- social organization, mating, hierarchy, kinship, division of labor, conflict, and cooperation;
- interactions with other creatures, settlements, weather, terrain, trade, agriculture, and travel;
- causal physical evidence: spoor, tracks, smell, remains, damage, nests, burrows, camps, tools, refuse, territorial marks, sounds, missing livestock, prey depletion;
...
- guarantee foreshadowing or evidence where the established creature would not plausibly leave it.

## Resolution procedure

When a consequential ecology question is not already answered by active 2e/setting/adventure sources or campaign state:
...
- `Compatible Candidate` after source/setting filtering;
- `Rejected Candidate` if incompatible;
- `Established DM Truth` only after campaign resolution/persistence through normal procedures.
