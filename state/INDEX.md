...
- Mandatory monster projection/runtime trigger extension for first-use source lookup, lazy projection creation, encounter instantiation, population promotion, Voice preload, and invalidation routing: `state/rulings/monster-runtime-triggers.md`
...
Whenever `state/rulings/dm-procedure-triggers.md` is loaded for normal play, treat `state/rulings/regional-runtime-triggers.md`, `state/rulings/site-and-craft-triggers.md`, and `state/rulings/monster-runtime-triggers.md` as mandatory companions whenever their domains are implicated.
...
- Normative monster projection / encounter-instance / population-layer policy: `MONSTER_PROJECTION_POLICY.md`
...
For monsters specifically, use: encounter-instance state -> verified generic monster projection -> exact active monster source entry -> broader uploaded-source search. Generic source projections must remain separate from campaign population/site-group state and from the actual creatures' encounter state.
...
- Mandatory monster source-projection/encounter-layer policy when monsters are consequential: `MONSTER_PROJECTION_POLICY.md`
...
- Monster first-use authority, lazy projection, encounter-instance separation, population promotion, Voice preload, source fallback, and supplement-precedence regression scenarios: `tests/MONSTER_PROJECTION_REGRESSION.md`
...
- Monster projection / encounter runtime policy: `MONSTER_PROJECTION_POLICY.md`
...
- Monster runtime trigger extension: `state/rulings/monster-runtime-triggers.md`
